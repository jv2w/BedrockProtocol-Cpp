...
class PlayerListPacket final : public DataPacket, public ClientboundPacket {
public:
    ...
    static PlayerListPacket remove(std::vector<types::PlayerListEntry> entries);

    [[nodiscard]] std::uint32_t networkId() const override { return NETWORK_ID; }
    [[nodiscard]] std::string_view getName() const override { return "PlayerListPacket"; }
