 ...
 */
class OpenSignPacket final : public DataPacket, public ClientboundPacket {
public:
    static constexpr std::uint32_t NETWORK_ID = ProtocolInfo::OPEN_SIGN_PACKET;
     ...
     */
    static OpenSignPacket create(types::BlockPosition blockPosition, bool front);
