...
SmithingTrimRecipe SmithingTrimRecipe::decode(encoding::ByteBufferReader &in)
{
    ...
    return SmithingTrimRecipe(std::move(recipeId), std::move(template_), std::move(input),
